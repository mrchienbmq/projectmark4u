			...
			<div class="row align-items-center">
				...
				<div class="col-lg-4 offset-lg-1">
					<div class="register_form">
						...
						<form class="form_area" action="{{url("home/follow")}}" method="post">
							@csrf
							<div class="row">
								<div class="col-lg-12 form_group">
									<input value="{{old("fullname")}}" name="fullname" placeholder="Full Name" required="required" type="text">
									<input value="{{old("phonenumber")}}" name="phonenumber" placeholder="Your Phone Number" required="required" type="number">
									<input value="{{old("email")}}" name="email" placeholder="Your Email Address" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" required="required" type="email">
								</div>
