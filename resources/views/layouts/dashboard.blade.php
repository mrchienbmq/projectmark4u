...
<head>
    ...
    <link href="{{asset("assets/css/4.1.3/css/bootstrap.css")}}" rel="stylesheet">
    <link href="{{asset("assets/css//css/dataTables.bootstrap4.min.css")}}" rel="stylesheet">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route("dashboard")}}">
            ...
            <div class="sidebar-brand-text mx-3">Manager Student<sup>2</sup></div>
        </a>
...
<script src="{{asset("assets/js/datatable/js/dataTables.bootstrap4.min.js")}}"></script>
